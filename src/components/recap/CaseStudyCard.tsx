  ...
  return (
    <Card bordered={false} className="bg-brand-gray px-6 py-8 sm:px-10 sm:py-12">
      <div className="flex flex-col items-start gap-4">
        <p className="font-grotesk text-xl font-bold leading-snug text-black sm:text-h3">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-3 font-grotesk text-base leading-6 text-black"
        >
