      ...
      {pageCount > 1 && (
        <>
          <button
            ...
            onClick={goPrev}
            className="absolute left-2 top-1/2 -translate-y-1/2 rounded-full border border-black bg-white p-1.5"
          >
          ...
          <button
            ...
            onClick={goNext}
            className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full border border-black bg-white p-1.5"
          >
