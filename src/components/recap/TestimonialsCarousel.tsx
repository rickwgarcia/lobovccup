        ...
        {visible.map((testimonial) => (
          ...
          >
            <div className="relative w-full max-w-[606px]">
              <img src={testimonialBubble} alt="" className="aspect-[606/380] w-full" />
              <p className="absolute left-[8.5%] top-[11%] w-[85%] font-grotesk text-sm leading-normal text-black sm:text-body">
